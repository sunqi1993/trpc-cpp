...
class ByteConsulSelectorFilter : public MessageClientFilter {
 public:
  ByteConsulSelectorFilter() { selector_flow_ = std::make_unique<SelectorWorkFlow>("byte_consul", false, false); }

  ~ByteConsulSelectorFilter() override {}
  ...
  /// @brief plugin name
  std::string Name() override { return "byte_consul"; }
